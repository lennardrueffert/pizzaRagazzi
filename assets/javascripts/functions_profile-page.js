...
function getUsernameFromDatabase() {
   document.getElementById("username").textContent = "Max"
   /*Original----------
...
function getMailFromDatabase() {
   //Ported------------
   document.getElementById("mail").textContent = "Email: " + "muster@mail.com"
   /*Original----------
...
function getGesamtpunkteFromDatabase() {
    //Ported------------
    document.getElementById("gesamtpunkte").textContent = "Gesamtpunkte: " + "4200"
    /*Original----------
...
function getHighscoreFromDatabase() {
    //Ported------------
    document.getElementById("highscore").textContent = "Highscore: " + "800"
    /*Original----------
...
function getTierFromDatabase() {
    //Ported------------
    document.getElementById("tier").textContent = "Rang: " + "Tester";
    /*Original----------
...
function getProfilePicFromDatabase() {
    document.getElementById("profile-picture").setAttribute("src", "assets/images/tester_profilepicture.jpg")
/*Original----------
